...
alterar os atributos visuais dos vértices e arestas de um grafo dinâmico.
}
...
change the visual attributes of the vertices and edges of a dynamic graph.
}
...
\input{chapters/2grafoestdin}
\input{chapters/3fundamentacao-teorica}
\input{chapters/4validacao}
\input{chapters/5conclusao}
