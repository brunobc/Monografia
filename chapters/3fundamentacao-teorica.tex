...
% O algoritmo de Dijkstra Modificado de \cite{leonard} possui uma falha no momento em que modifica o
% intervalo de previsão, pois ele só é alterado quando o tempo parcial é ultrapassado de 10 minutos,
% e com isso, o rótulo do vértice destino é alterado após percorrer a aresta.
% O grafo G(N=\{B1, B2, B3\}, A) apresentado na figura \ref{fig:critica}, é utilizado para demonstrar essa falha.
% 
% \begin{figure}[htbp]
% \centering
%  \includegraphics[width=.60\textwidth]{chapters/fig/critica.png}
% \caption{Grafo exemplo - Algoritmo de Dijkstra Modificado}
% \label{fig:critica}
% \end{figure}
% \FloatBarrier
% 
% Inicialmente, o vértice B1 é selecionado como nó raiz para determinar o caminho mínimo. Ele possui o vértice B2
% como adjacente, que em seguida é rotulado com o valor 8.
...
A seguir, é apresentada a sequência de instantes após resolução do algoritmo utilizando o dynagraph.
