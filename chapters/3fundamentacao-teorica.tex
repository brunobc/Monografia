...
\If {custoVerticeSelecionado > janelaTemporalAtual}
...
\If {custoAresta + custoVerticeSelecionado < custoVerticeDestino}
  ...
  \State predecessor verticeDestino $\leftarrow$ verticeSelecionado \Comment{predecessor[v] $\leftarrow$ u}
\EndIf
\end{algorithmic}
...
\begin{figure}[htbp]
\centering
 \includegraphics[width=.42\textwidth]{chapters/fig/dyndyn4.png}
 \includegraphics[width=.42\textwidth]{chapters/fig/dyndyn5.png}
...
\begin{figure}[htbp]
\centering
 \includegraphics[width=.42\textwidth]{chapters/fig/dyndyn6.png}
 \includegraphics[width=.42\textwidth]{chapters/fig/dyndyn7.png}
