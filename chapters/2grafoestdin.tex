...
\item Em um grafo ou dígrafo com elos ou arcos dinâmicos, o conjunto $L$ varia com o tempo. Assim, as arestas ou arcos podem
...
Na figura \ref{fig:jsondynagraph} ``binding'' são definidas as características dos vértices e arestas. Seguindo o exemplo da figura \ref{fig:jsondynagraph}, ``vertex'' poderá
